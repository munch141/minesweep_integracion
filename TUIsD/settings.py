"""
Django settings for TUIsD project.
...
SECRET_KEY = 'uxhx)yygzb*j!ad!ogo62q5j-b@gb9fkjuyfg(ve_i-s!h(-n3'
...
ROOT_URLCONF = 'TUIsD.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'TUIsD/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'TUIsD.wsgi.application'
