...
class Form(unittest.TestCase):
    ...
    def test_form(self):
        ...
        driver.find_element_by_xpath("/html/body/div/div[1]/div/div[1]/ul/li/div[3]/div/div[9]/div/ol/li[1]/input[2]").send_keys("Hola")
        driver.find_element_by_xpath("/html/body/div/div[1]/div/div[1]/ul/li/div[3]/div/div[9]/div/ol/li[2]/input[2]").send_keys("que")
        driver.find_element_by_xpath("/html/body/div/div[1]/div/div[1]/ul/li/div[3]/div/div[9]/div/ol/li[3]/input[2]").send_keys("tal")
