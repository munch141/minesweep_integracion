...
class Form(unittest.TestCase):
    ...
    def test_form(self):
        ...
        driver.find_element_by_xpath("/html/body/div/div[1]/div/div[1]/ul/li/div[3]/div/div[3]/div/input").send_keys("Hola mundo")
        ...
        driver.find_element_by_xpath("/html/body/div/div[1]/div/div[1]/ul/li[2]/div[3]/div/div[3]/div/input").send_keys("Ayuda")
        driver.find_element_by_link_text("Cerrar").click()

       
        time.sleep(5)
        driver.find_element_by_xpath("//span[contains(.,'Campo de Fecha')]").click()
        driver.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[1]/ul/li[3]/div[1]/a[2]")
        driver.find_element_by_xpath("/html/body/div/div[1]/div/div[1]/ul/li[3]/div[3]/div/div[4]/div/input").send_keys("Hola Mundo")

        
        time.sleep(5)
        driver.find_element_by_xpath("//span[contains(.,'Subida de archivo')]").click()
        driver.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[1]/ul/li[4]/div[1]/a[2]")


        time.sleep(5)
        driver.find_element_by_xpath("//span[contains(.,'Título')]").click()
        driver.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[1]/ul/li[5]/div[1]/a[2]")
        ...
        driver.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[1]/ul/li[10]/div[1]/a[2]")
